...
type Storage interface {
	...
	Put(key, value []byte, rev uint64, lease int64) (ikv *util.InternalKV, err error)
	Delete(key []byte, rev uint64) (ikv *util.InternalKV, err error)
...
type Transaction interface {
	...
	Put(key, value []byte, lease int64) (ikv *util.InternalKV, err error)
	Delete(key []byte) (ikv *util.InternalKV, err error)
