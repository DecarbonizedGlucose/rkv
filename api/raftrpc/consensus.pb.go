...
import (
	rsmpb "github.com/DecarbonizedGlucose/rkv/api/rsm/rsmpb"
...
type LogEntry struct {
	...
	Log           *rsmpb.Command         `protobuf:"bytes,2,opt,name=log,proto3" json:"log,omitempty"`
...
func (x *LogEntry) GetLog() *rsmpb.Command {
	if x != nil {
		return x.Log
	}
	return nil
...
var file_api_raftrpc_consensus_proto_goTypes = []any{
	...
	(*rsmpb.Command)(nil),         // 5: rsm.Command
}
